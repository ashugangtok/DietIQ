    ...
    return (
        <div className="border rounded-lg p-6 bg-white font-poppins" ref={ref}>
            <div className="text-center mb-6">
                ...
                <p className="text-lg text-gray-500">Overall Diet Report</p>
                 {reportDate ? (
...
export function OverallReport({ data }: OverallReportProps) {
    ...
    const handleDownloadPdf = async () => {
        ...
        if (element) {
            ...
            pdf.save(`${selectedGroup}-overall-report.pdf`);
        }
    };
    ...
    return (
        <Card className="shadow-lg">
            <CardHeader>
                <CardTitle className="font-headline text-xl">Overall Report</CardTitle>
                <CardDescription>
                    Select a meal group to view a consolidated diet report across all sites.
                </CardDescription>
            </CardHeader>
